...
In order to support loading of multiple wallets in londinium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is londinium.cpp.
...
Changes to londinium.cpp
----------------------
londinium.cpp is the entry point into londinium-qt, and as such, will require some minor modifications to provide hooks for
