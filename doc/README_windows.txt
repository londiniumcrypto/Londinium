...
Intro
-----
Londinium (LON) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Londinium utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run londinium-qt.exe.

Londinium Core is the original Londinium client and it builds the backbone of the network.
However, it downloads and stores the entire history of Londinium transactions;
