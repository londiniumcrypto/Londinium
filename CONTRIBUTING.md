Contributing to Londinium Core
==================================

The Londinium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Londinium Core project, and is not to be
confused with overall Londinium Network Protocol consensus changes.

Whether a pull request is merged into Londinium Core rests with the project merge
...
Patches that change Londinium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Londinium consensus, it must have been
...
The project leader is the release manager for each Londinium Core release.
