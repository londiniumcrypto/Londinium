...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Londinium Core londinium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  londinium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded londinium transaction") + "\n" +
                               "  londinium-tx [options] -create [commands]   " + _("Create hex-encoded londinium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded londinium transaction
