...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Londinium Core"),
     ...
     * override -datadir in the londinium.conf file in the default data directory
     * (to be consistent with londiniumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
