...
/** Utility functions used by the Londinium Qt UI.
 */
namespace GUIUtil
{
...
// Render LON addresses in monospace font
...
// Parse "londinium:" URI into recipient object, return true on successful parsing
