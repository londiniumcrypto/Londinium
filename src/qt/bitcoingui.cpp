                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Londinium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LON address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and londinium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Londinium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Londinium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Londinium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LON addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LON addresses"));
    ...
    openAction->setStatusTip(tr("Open a londinium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Londinium Core help message to get a list with possible Londinium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Londinium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Londinium network", "", count));
}
...
{
    QString strTitle = tr("Londinium Core"); // default title
