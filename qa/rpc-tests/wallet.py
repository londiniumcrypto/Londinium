...
#   c) node1 mines 32 blocks, so now node 0 has 500000LON, node 1 has 4250LON, node2 has none.
#   d) node0 sends 601 LON to node2, in two transactions (301 LON, then 300 LON).
